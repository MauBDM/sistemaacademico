...
<!DOCTYPE html>
    ...
    <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="mostrar.php" data-toggle="tab">Responsables</a></li>
                        </ul>
                </div>
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="Activos">
    <center><h3> Listado de Responsables</h3></center>
    <div id="loader" class="text-center">
      <img src="../img/loader.gif"></div>
      <form class="form-horizontal">
            <div class="form-group">
            <div class="col-sm-6">
              <input type="text" class="form-control" id="q" placeholder="Buscar responsable del estudiante" onkeyup="load(1)" autocomplete="off">
            </div>
  ...
  <!-- Latest compiled and minified JavaScript -->
    ...
    <?php
       include("busca.php");
      include("modales_responsable.php");
    ?>
    </div>
</div>
  <?php
