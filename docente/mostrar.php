...
<!DOCTYPE html>
  ...
  <?php
   ...
   <div class="form-panel">
    ...
    <center><h3> Listado de docentes</h3></center>
<div class=' pull-right'>
<?php if ($idtipoUsu==1){ ?>

<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal_docente">
  <i class="fa fa-plus" ></i>&nbsp;&nbsp;
  <span class="tooltips" data-placement="left" data-original-title="Registrar docente.">Agregar</span>
</button>
<?php } ?>
</div>
