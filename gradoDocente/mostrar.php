...
<!DOCTYPE html>
  ...
  <?php
   ...
   <div class="form-panel">
    ...
    <center><h3> Año Lectivo Actual</h3></center>
<div class=' pull-right'>
<?php if ($idtipoUsu==1){ ?>

<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal_gradoDocente">
  <i class="fa fa-plus" ></i>&nbsp;&nbsp;
  <span class="tooltips" data-placement="left" data-original-title="Registrar nueva aula">Agregar</span>
</button>
<?php } ?>
</div>
    <div id="loader" class="text-center">
      ...
      <form class="form-horizontal">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="q" placeholder="Buscar grado" onkeyup="load(1)">
            </div>
  ...
  <!-- Latest compiled and minified JavaScript -->
    ...
    <?php
       include("busca.php");
      include("modales_gradoDocente.php");
    ?>
    </div>
</div>
  <?php
