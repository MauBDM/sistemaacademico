...
<div class="modal fade" id="modal_asignatura" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">x</span></button>
<center><h4 class="modal-title">Nueva Asignatura</h4></center>
</div>
...
<input type="text" class="form-control" onkeypress="return soloLetras(event);" title="Ingresar más de 3 letras" placeholder="Ingresar el nombre de la asigntura" pattern=".{3,44}" name="nombre_grd" required="">
</div>
</div>
...
<div class="col-sm-9">
<!-- Evento solo minusculas-->
<input type="text" class="form-control" onkeypress="return soloLetras(event);" title="Ingresar más de 3 letras" placeholder="Ingresar el nombre de la asigntura" pattern=".{3,44}" name="mod_nombre" id="mod_nombre" required="">
</div>
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"> </span> Cerrar</button>
