...
<!DOCTYPE html>
  ...
  <?php
   ...
   <div class="form-panel">
    ...
    <center><h3> Listado de estudiantes activos</h3></center>
<div class=' pull-right'>
  <a href="registrar.php" class="btn btn-default">
    <i class="fa fa-plus" ></i>&nbsp;&nbsp;<span class="tooltips" data-placement="left" data-original-title="Registrar nuevo estudiante.">Agregar</span>
  </a>
</div>
    <div id="loader" class="text-center">
      ...
      <form class="form-horizontal">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="q" placeholder="Buscar estudiantes" onkeyup="load(1)">
            </div>
  ...
  <!-- Latest compiled and minified JavaScript -->
    ...
    <?php
       include("busca.php");
      include("modales_estudiante.php");
    ?>
    </div>
</div>
  <?php
