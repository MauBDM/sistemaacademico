...
/*Condicion para hacer la busqueda dentro de la paginación*/
  if($action == 'ajax'){
    ...
    //Arreglo de columnas donde se realizara la busqueda. Deacuerdo a las columnas
     $aColumns = array('matricula.idmatricula','matricula.fecha', 'docente_asignatura.iddocenteAsignatura','docente_grado.iddocente_grado','matricula.nie');//Columnas de busqueda
  ...
  foreach($model as $row){ //Mostrar los datos encontrados en la BD $model, $row tomados lineas atras.    
    ?>
       ...
       ?>
        ...
        <!-- envio de datos-->
        <input type="hidden" value="<?php echo $row['año'];?>" id="año<?php echo $row['iddocente_grado'];?>">
        <input type="hidden" value="<?php echo $row['turno'];?>" id="turno<?php echo $row['iddocente_grado'];?>">
        <input type="hidden" value="<?php echo $row['tipo'];?>" id="tipo<?php echo $row['iddocente_grado'];?>">
        <input type="hidden" value="<?php echo $row['guia'];?>" id="guia<?php echo $row['iddocente_grado'];?>">
        <input type="hidden" value="<?php echo $row['idgrado'];?>" id="idgrado<?php echo $row['iddocente_grado'];?>">
        <input type="hidden" value="<?php echo $row['iddocente_grado'];?>" id="iddocente_grado<?php echo $row['iddocente_grado'];?>">
       <?php
